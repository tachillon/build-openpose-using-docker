...
RUN git clone --depth 1 -n https://github.com/CMU-Perceptual-Computing-Lab/openpose.git && cd openpose && git checkout 6f0b8868bc4833b4a6156f020dd6d486dcf8a976

RUN mv ./openpose /opt/openpose

COPY ./install_deps.sh /opt/openpose/scripts/ubuntu/install_deps.sh

RUN bash /opt/openpose/scripts/ubuntu/install_deps.sh
